...
Icp_pose_estimation::Icp_pose_estimation(){
    ...
    ////////////////////////////////////////////////
    toteModel.reset(new PointCloud<PointXYZRGB>()); 
    ...
    preprocessed_cloud.reset(new PointCloud<PointXYZRGB>()); 
    load_models();
...
void Icp_pose_estimation::addNormal(PointCloud<PointXYZRGB>::Ptr cloud, PointCloud<PointXYZRGBNormal>::Ptr cloud_with_normals)
{
...
vector<double> Icp_pose_estimation::point_2_plane_icp (PointCloud<PointXYZRGB>::Ptr sourceCloud, PointCloud<PointXYZRGB>::Ptr targetCloud, PointCloud<PointXYZRGBNormal>::Ptr cloud_source_trans_normals ){
...
void Icp_pose_estimation::update_points(const sensor_msgs::PointCloud2::ConstPtr& cloud){
	  pcl::fromROSMsg (*cloud,*scene_cloud);
  	return;
}

void Icp_pose_estimation::icp_point_cloud_preprocessing(PointCloud<PointXYZRGB>::Ptr object_cloud){
...
void Icp_pose_estimation::background_align (PointCloud<PointXYZRGB>::Ptr background_model,PointCloud<PointXYZRGB>::Ptr scene_clouds, PointCloud<PointXYZRGB>::Ptr background_clouds){
...
void Icp_pose_estimation::background_extraction(PointCloud<PointXYZRGB>::Ptr background_clouds,PointCloud<PointXYZRGB>::Ptr scene_clouds){
...
void Icp_pose_estimation::icp_vis (PointCloud<PointXYZRGB>::Ptr model_point,  pcl::PointCloud<PointXYZRGBNormal>::Ptr icp_result_point,vector<double> product_pose){
...
void Icp_pose_estimation::object_cloud_filtering(PointCloud<PointXYZRGB>::Ptr cloud ,cv_bridge::CvImagePtr mask,string object){
...
void Icp_pose_estimation::icp_cb(const sensor_msgs::Image::ConstPtr& mask){
